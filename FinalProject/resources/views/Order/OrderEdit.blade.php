        ...
        <div class="col-md-10">
            ...
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white fs-5 fw-bold">
                    <i class="bi bi-cart-plus"></i> Edit Order
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('order.update', $order->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-pill" id="name" name="name" value="{{ $order->name }}" required>
                        </div>
                        ...
                        <table class="table table-bordered" id="products_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="quantities[]" class="form-control" min="1" value="{{ $product->pivot->quantity }}" required>
                                    </td>
                                    <td>
